...
export const NAV_ITEMS: NavItemConfig[] = [
  ...
  { id: 'business',   label: 'Erhverv',          icon: React.createElement(BarChart3, { className: "h-5 w-5" }),       showFor: ['tsl'] },
  { id: 'personal',   label: 'Privat',           icon: React.createElement(User, { className: "h-5 w-5" }),            showFor: ['umit'] },
