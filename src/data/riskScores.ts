...
export const riskHeatmapData: RiskScore[] = [
  {
    ...
    likelihood: 5,
    impact: 5,
    justification: 'Akut illikviditet (31 DKK i kasse), ekstremt høj DSO (~358 dage) og stor kapitalbinding i koncerninterne tilgodehavender (12,4 mio. kr). Selskabet er operationelt insolvent.',
    linkedHypotheses: ['H3', 'H4'],
    linkedViews: ['cashflow', 'financials'],
    linkedActions: ['Implementer Stram Debitorstyring', 'Oprydning i Intercompany-mellemværender', 'Etabler Likviditetsbuffer og Cash Forecast'],
  },
  {
    ...
    likelihood: 4,
    impact: 5,
    justification: 'Verserende skattesag på op til 4 mio. kr., samt revisorbemærkning om forkert momsafregning med eksplicit nævnelse af potentielt ledelsesansvar. Solidarisk hæftelse i koncern forøger risikoen.',
    linkedHypotheses: ['H4'],
    linkedViews: ['timeline', 'actions'],
    linkedActions: ['Indhent Fuld Sagsmappe fra Skattestyrelsen', 'Engager Skattespecialist til Analyse & Second Opinion'],
  },
  {
    category: 'Governance',
    maxScore: 20,
...
export const totalRiskScore = {
  ...
  level: 'KRITISK',
  summary: 'Samlet risikoprofil er kritisk, primært drevet af en eksistentiel likviditets- og solvensrisiko samt en substantiel juridisk risiko fra skattesagen. Operationel performance er under stærkt pres. Casen kræver akut intervention.'
};
...
export const relationRiskData: RelationRisk[] = [
    ...
    { entity: 'Cömert Avci', type: 'Person', role: 'Tidligere direktør (CESR ApS)', riskScore: 40, reason: 'Bekræftet brud i 2025. Har stiftet ny holding (Rcim Holding ApS). Årsag til brud er ukendt, men indikerer konflikt.' },
    { entity: 'Muhamed Danyal Tirpan', type: 'Person', role: 'Tidligere ledelse (Lund Capital)', riskScore: 35, reason: 'Bekendt af Cetin; involveret i tidligere ventures. Potentiel omdømmerisiko grundet begrænset info.' },
    ...
    { entity: 'CESR Ejendomme ApS', type: 'Selskab', role: 'Kapitalmodtager (Aktiv)', riskScore: 28, reason: 'Modtager 6.55M+ DKK i kapital. Lovlig risikospredning, men er destinationen for den kapitaldræn, der skaber illikviditet i driften.' },
];