import { SectorDriver, SectorBenchmarkYear, SectorComparisonMetric, MacroRisk } from '../../types';
...
export const macroRiskData: MacroRisk[] = [
    {
        id: 'macro-1', 
        title: 'Markeds- & prispres', 
        level: 'Høj', 
        description: 'Hård konkurrence, pres på marginer fra kunder og konsolidering i både transport- og bilbranchen.', 
        linkedSubjects: ['tsl'], 
        sourceId: 'risk_macro_v2'
    },
    {
        id: 'macro-2', 
        title: 'Regulatoriske ændringer', 
        level: 'Høj', 
        description: 'Ny km-afgift (transport) og ændringer i bilafgifter/miljøkrav (bilhandel) udgør en betydelig økonomisk usikkerhed.', 
        linkedSubjects: ['tsl'], 
        sourceId: 'risk_macro_v2'
    },
    {
        id: 'macro-3', 
        title: 'Makroøkonomisk klima', 
        level: 'Middel', 
        description: 'Højere renter og inflation påvirker finansieringsomkostninger og efterspørgsel i begge brancher.', 
        linkedSubjects: ['tsl'], 
        sourceId: 'risk_macro_v2'
    },
    {
        id: 'macro-4', 
        title: 'Teknologisk disruption', 
        level: 'Middel', 
        description: 'Krav om digitalisering i transport og skift til online-salg/elbiler i bilbranchen kræver konstante investeringer.', 
        linkedSubjects: ['tsl'], 
        sourceId: 'risk_macro_v2'
    }
];