...
export const nodes: NetworkNode[] = [
  ...
  { id: 'fstyr', label: 'Færdselsstyrelsen', sublabel: 'Tilladelser', type: 'historical', x: 350, y: 350, riskLevel: 'High', notes: 'Kritisk usikkerhed om "license to operate".' },
];
...
export const edges: NetworkEdge[] = [
  ...
  { from: 'ts_logistik', to: 'fstyr', type: 'transaction' },
];