...
export const timelineData: TimelineEvent[] = [
  ...
  },
  {
    ...
    description: 'Cömert Avci udtræder som direktør for CESR ApS efter formodet uenighed. Ümit Cetin overtager fuld kontrol.',
  ...
  },
  {
    ...
    description: 'Opslag i Færdselsstyrelsens register bekræfter, at TS Logistik ApS besidder de påkrævede vognmandstilladelser (Licensnr. 4087192).',
